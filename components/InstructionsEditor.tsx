  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-8">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h1 className="text-xl font-semibold text-zinc-900">Instructions</h1>
        {state && (
      ...
      <p className="mb-4 text-sm text-zinc-500">
        This file is the <strong>single source of the design system</strong> (FR-47): the human-readable
        style rules go into every AI prompt, and the <code>TOKENS</code> block drives both the HTML preview
        and the PDF. Every conversion also records a copy with the document (FR-23) — old documents keep
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="rounded-md border border-zinc-300 bg-white px-4 py-1.5 text-sm font-medium text-zinc-700 hover:bg-zinc-50 disabled:opacity-40"
        >
          Reset to repo file
        </button>
      ...
      {loading && !state ? (
        ...
        <textarea
          ...
          rows={40}
          spellCheck={false}
          className="w-full rounded-lg border border-zinc-200 bg-zinc-50 p-4 font-mono text-[13px] leading-relaxed text-zinc-800 outline-none focus:border-blue-400 focus:bg-white"
        />
      )}
